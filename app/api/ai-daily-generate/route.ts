...
const AI_NEWS_SOURCES = [
  ...
  { 
    ...
    category: 'Industry',
    searchUrl: 'https://artificialintelligence-news.com/?s=artificial+intelligence',
  ...
  { 
    ...
    category: 'Research',
    searchUrl: 'https://syncedreview.com/?s=artificial+intelligence',
  ...
  { 
    ...
    category: 'Business',
    searchUrl: 'https://aibusiness.com/?s=artificial+intelligence',
    rssUrl: 'https://aibusiness.com/feed/',
    region: 'international'
  },
  { 
    name: 'Wired', 
    ...
    category: 'Technology',
    searchUrl: 'https://www.wired.com/search/?query=artificial+intelligence',
